...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
  ...
  <!-- Browser title -->
	...
	<link rel="stylesheet" type="text/css" media="all" href="../rw_common/themes/Voyager/consolidated.css?rwcache=522216395" />
...
<?php unset($_SESSION['form']); ?>
  ...
  <script src="../rw_common/themes/Voyager/js/jquery.min.js?rwcache=522216395"></script>

	<!-- Base RapidWeaver javascript -->
	<script async type="text/javascript" src="../rw_common/themes/Voyager/javascript.js?rwcache=522216395"></script>

  <!-- Elixir theme specific javascript, along with jQuery Easing and a few other elements -->
  <script src="../rw_common/themes/Voyager/js/elixir.js?rwcache=522216395"></script>

	<!-- Style variations -->
	<script type="text/javascript" src="../rw_common/themes/Voyager/js/sidebar/sidebar_right.js?rwcache=522216395"></script>
